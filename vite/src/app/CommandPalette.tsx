	...
	const navigationItems = [
		{
			...
			icon: <PackageIcon className="mr-2 size-3" />,
			onSelect: () => {
		...
		},
		{
			...
			icon: <StackIcon className="mr-2 size-3" />,
			onSelect: () => {
		...
		{
			label: "Go to Rewards",
			icon: <GiftIcon className="mr-2 size-3" />,
			onSelect: () => {
		...
		},
		{
			...
			icon: <ArrowsClockwiseIcon className="mr-2 size-3" />,
			onSelect: () => {
				handleEnvChange(
